...
public class FileUtil {
    ...
    public static void writeToXmlForCategory(String path, List<Category> categories) throws IOException {
        CategoryWrapper wrapper = new CategoryWrapper(categories);
        xmlMapper.writerWithDefaultPrettyPrinter().writeValue(new File(path), wrapper);
    }
}
